...
SECRET_KEY = '6tf1*b4&k$c*f10q-89l+ud9oofgpoy&z*0qzzp_iq(u6jl8^4'
...
ROOT_URLCONF = 'spoilr.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'spoilr.wsgi.application'
